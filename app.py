...
# Enable CORS: allow frontend origin (or * for testing)
CORS(app, origins=[os.getenv("CORS_ORIGIN", "*")])

# 🔐 API Keys
API_KEY = os.getenv("API_KEY")  # your private key for direct usage
RAPIDAPI_KEY = os.getenv("RAPIDAPI_KEY")  # optional, if publishing via RapidAPI
